## 
# Generated with hmexpfamily 0.1.0+editable 2023-06-02T21:24:07.175866
...
# USEAERO: climaero -> camsnrt
sed -i 's/^USEAERO=climaero/USEAERO=camsnrt/' ecf/config_exp.h

# CAERO: tegenaod -> __ignored__
sed -i 's/^CAERO=tegenaod/CAERO=__ignored__/' ecf/config_exp.h
