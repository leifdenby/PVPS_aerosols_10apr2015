## 
# Generated with hmexpfamily 0.1.0+editable 2023-06-02T21:24:07.171969
...
# Create a directory to store the CAMSNRT variant of the
# PVPS_aerosols_10apr2015 experiment
mkdir variant__CAMSNRT
...
# to be
ln -s /etc/ecmwf/nfs/dh2_perm_b/nhae/Projects/PVPS/experiment_families/10apr2015/variant__CAMSNRT $PERM/hm_home/PVPS_aerosols_10apr2015__variant__CAMSNRT

# Create a symlink in output/variant__CAMSNRT to where Harmonie will
# place the output for ease of access later
ln -s $SCRATCH/hm_home/PVPS_aerosols_10apr2015__variant__CAMSNRT /etc/ecmwf/nfs/dh2_perm_b/nhae/Projects/PVPS/experiment_families/10apr2015/output/variant__CAMSNRT
